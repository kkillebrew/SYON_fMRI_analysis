# HM edited to handle no MT, no retExp 20230829
...
# set list of runs; HM updating to 10 (no MT, retExp)
...
# HM updating for this person (no MT, retExp)
set tr_counts = ( 255 255 263 313 313 163 163 163 163 255 )
...
# # add regressors
    ...
    else if ( ($run == 04) || ($run == 05) || ($run == 10) ) then # ss loc, ill loc, LOCloc
        set n_cond = 2
