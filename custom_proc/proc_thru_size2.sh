...
# set list of runs; this ppt has no size 3 (NoHall_LL), size 4 (NoHall_UL), MTLoc, LOCloc, or retExp
...
set tr_counts = ( 255 255 263 313 313 163 163 )
...
# # add regressors
    ...
    else if ( ( $run == 06 ) || ( $run == 07 ) ) then # size task
        set n_cond = 1
    ...
    else if ( ($run == 04) || ($run == 05) ) then # ss loc, ill loc
        set n_cond = 2
